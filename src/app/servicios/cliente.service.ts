...
export class ClienteService {
  ...
  getHistorial(){
    this.URL_API='https://st0repc2.herokuapp.com/api/usuario/historial'
    return this.http.get(this.URL_API)
  }

  getProductos(){
    this.URL_API='https://st0repc2.herokuapp.com/api/productos/listado'
    return this.http.get(this.URL_API)
  }

  getCarritos(){
    this.URL_API='https://st0repc2.herokuapp.com/api/usuario/carrito'
    return this.http.get(this.URL_API)
  }

  postCarrito(producto){
    this.URL_API='https://st0repc2.herokuapp.com/api/productos/semicompra'
    return this.http.post(this.URL_API, {producto: producto.producto, precio: producto.precio, cantidad: producto.cantidad})
  }

  postCompra(producto){
    this.URL_API='https://st0repc2.herokuapp.com/api/productos/comprar'
  ...
  deleteCarrito(producto){
    this.URL_API='https://st0repc2.herokuapp.com/api/usuario/deletecarrito'
